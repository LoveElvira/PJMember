...
package com.humming.pjmember.google.zxing.view;
...
public final class ViewfinderView extends View {
  ...
  private static final int    CORNER_RECT_WIDTH             =   16;  //扫描区边角的宽  8
  private static final int    CORNER_RECT_HEIGHT            =   80; //扫描区边角的高  40
  private static final int    SCANNER_LINE_MOVE_DISTANCE    =   5;  //扫描线移动距离  5
  private static final int    SCANNER_LINE_HEIGHT           =   20;  //扫描线宽度    10
