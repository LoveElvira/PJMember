package com.humming.pjmember.google.zxing.activity;
...
import com.humming.pjmember.google.zxing.decoding.InactivityTimer;
import com.humming.pjmember.google.zxing.decoding.RGBLuminanceSource;
import com.humming.pjmember.google.zxing.view.ViewfinderView;
...
public class CaptureActivity extends BaseActivity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        openLight = (LinearLayout) findViewById(R.id.activity_scanner__open_light);
        open = (ImageView) findViewById(R.id.activity_scanner__open_light_);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.base_toolbar__left_image:
                ...
                break;
            case R.id.activity_scanner__open_light:
                // 是否支持闪光灯
                if (DeviceUtils.isSupportCameraLedFlash(getPackageManager())) {
                    CameraManager.get().toggleFlashMode();
                } else {
                    showShortToast("不支持开启闪光灯");
                }
                break;
            case R.id.activity_scanner__open_light_:
...
//                                handler.sendMessage(m);
                                ...
                                bundle.putString(INTENT_EXTRA_KEY_QR_SCAN, recode(result.getText()));
